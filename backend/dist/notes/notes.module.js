...
const note_folders_controller_1 = require("./note-folders.controller");
...
exports.NotesModule = NotesModule = __decorate([
    (0, common_1.Module)({
        controllers: [notes_controller_1.NotesController, note_folders_controller_1.NoteFoldersController],
